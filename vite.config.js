  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        builds_budget: resolve(__dirname, 'source/builds/budget.html'),
        builds_midrange: resolve(__dirname, 'source/builds/midrange.html'),
        builds_highend: resolve(__dirname, 'source/builds/highend.html'),
